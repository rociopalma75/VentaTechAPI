...
namespace Infraestructure.Repositories.CrudRepositories
{
    ...
    {
        public EmpleadoRepository(VentaTechContext context) : base(context)
        {
        }
        protected override Expression<Func<Empleado, object>>[] PropertiesNavigations => [e => e.TipoRol, e => e.Departamento];
